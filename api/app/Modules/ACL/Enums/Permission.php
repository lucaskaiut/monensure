...
enum Permission: string
{
    ...
    case ASSISTANT_MANAGE = 'assistant.manage';

    case PAYABLE_CREATE = 'payable.create';
    case PAYABLE_READ = 'payable.read';
    case PAYABLE_UPDATE = 'payable.update';
    case PAYABLE_PAY = 'payable.pay';
    case PAYABLE_DELETE = 'payable.delete';
    ...
    case RECURRENCE_CREATE = 'recurrence.create';
    case RECURRENCE_READ = 'recurrence.read';
    case RECURRENCE_UPDATE = 'recurrence.update';
    case RECURRENCE_DELETE = 'recurrence.delete';

    case CASHFLOW_READ = 'cashflow.read';
